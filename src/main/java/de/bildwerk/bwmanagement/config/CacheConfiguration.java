package de.bildwerk.bwmanagement.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, de.bildwerk.bwmanagement.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, de.bildwerk.bwmanagement.repository.UserRepository.USERS_BY_EMAIL_CACHE);
